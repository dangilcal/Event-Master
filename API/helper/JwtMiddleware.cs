...
namespace WebApi.Helpers
{
    public class JwtMiddleware
    {
        ...
        private readonly IUserService _identidadService;

        public JwtMiddleware(RequestDelegate next, IConfiguration configuration, IUserService service)
        {
            _next = next;
            _configuration = configuration;
            _identidadService = service;
        }
